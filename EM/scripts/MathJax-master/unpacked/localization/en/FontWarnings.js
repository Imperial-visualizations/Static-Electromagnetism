...
MathJax.Localization.addTranslation("en","FontWarnings",{
        ...
        strings: {
          ...
          imageFonts: "MathJax is using its images fonts rather than local or web-based fonts. This will render slower than usual, and the mathematics may not print at the full resolution of your printer.",
          noFonts: "MathJax is unable to locate a font to use to display its mathematics, and images fonts are not available, so it is falling back on generic Unicode characters in hopes that your browser will be able to display them. Some characters may not show up properly, or possibly not at all.",
