//Tim's div side of gauss law for electrostatics
...
function computeBasis(x3,y3) {
    ...
    console.log(widths)
    //unsure why but this loop is pushing widths correctly but they're being taken as opacity arguments?
    ...
    for (i=0; i<lhsx.length; i++){
        ...
        vertices.push(color= a.gObject(yolo[i], width=widths[i], opacity=1));
        vertices.push(color= a.arrowHead(yolo[i] , width=widths[i]));
    }
